...
class SimpleStringManipulationTest(TestCase):
    ...
    def test_split_string_remove_space(self):
        self.assertEqual(['a', 'b', 'c', 'd', 'e', 'f', 'g'],
                         yourtest.string_contains('hello', 'hello there'))
...
class SimpleDjangoHandler(TestCase):
    def test_handler(self):
        ...
        response = yourtest.handler(rf.get('/', {'name': u'박근혜','polite': 'True'}))
...
class SimpleOOTest(TestCase):
    def test_simple_inheritence_test(self):
        ...
        self.assert_(isinstance(megaman, yourtest.VideoGameCharacter))
        self.assert_(isinstance(mario, yourtest.VideoGameCharacter))
